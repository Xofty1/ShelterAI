...
SliderThemeData _sliderThemeData({required bool light}) => SliderThemeData(
      ...
      overlayColor: light
          ...
          : darkSurfaceColor.withOpacity(0.5),
...
InputDecorationTheme _inputDecorationTheme({required bool light}) =>
    InputDecorationTheme(
      filled: true,
      fillColor: light ? lightSurfaceColor : darkSurfaceColor,
      hintStyle: TextStyle(
          color: light
              ? lightOnBackgroundColor.withOpacity(0.5)
              : darkOnBackgroundColor.withOpacity(0.5)),
